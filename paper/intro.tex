...
Systems that track information flow at a fine-grained level, e.g. per
value in the system, offer great flexibility.  However, they
...
Leveraging this insight, we define a form of coarse-grained
dynamic IFC and show how it can be combined with any programming
language for which external effects can be controlled.
...
Using an approach by Matthews-Findler~\cite{Matthews:2007:OSM:1190216.1190220}
...
\begin{itemize}
  ...
  information flow control language free of non-IFC constructs.
