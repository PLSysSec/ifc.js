...
%format (TI (x))  = "\tar{^{\textrm{TI}}\lfloor}"x"\tar{\rfloor}"
...
%format true  = "\overline{\mathbf{true}}"
%format false = "\overline{\mathbf{false}}"
...
%format nil      = "\epsilon"
%format cons     = "\triangleleft"
%format filter (x) (y) = y "\preceq" x

%format conf (s) (e) = "\langle "s", "e"\rangle"
%format lconf (i) (l) (s) (e) = "\langle "s", "e"\rangle_{"i"}^{"l"}"
%%format iconf (t) (s) = { t inlinesep s }
%format iconf (t) (s) = { t inlinesep s }
