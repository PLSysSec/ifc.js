...
%format niconf (t) (i) (l) (e) = CE"_{"t"}\left["e"\right]^{"i"}_{"l"}"
...
%format targetLangML = "\Red{\lambda_{\text{ML}}}"
...
%format restrictedLang a x = "L_\text{IFC}^{\text{-}}(\mathcal{P},"a, x")"
%format restrictedLangNoRef a x = "L_\text{IFC}^{\text{-}}("noRefs","a, x")"
...
%format tab = "\ \ "
%format nlamp = "\\ &"
%format threadId = "\mathbf{threadId}"
