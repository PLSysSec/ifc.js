...
%
Here, we lastly remark that that---albeit in a straight forward
way---the TSNI proof must account for this new construct, since it
appears in the IFC calculus.
%}
