...
%
More generally, we belove that deterministic schedulers that always
...
%
For instance, since |alpha| is a map on task lists, schedulers
that rely on the global state |iS|, or previous task configurations
cannot be expressed.
%
Though, we do not belove this to be a fundamental limitation, our
