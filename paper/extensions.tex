...
Both the LIO and SWAPI implementations already support such features.
%
Extending our calculus to consider privileges
%
The challenge with such an extension, however, lies in the precise
