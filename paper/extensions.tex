...
Breeze~\cite{Hritcu:2013:YIB:2497621.2498098, lio}: |tv ::= cdots
inlinesep Lb il tv|.
%
...
%
Similarly, when creating labeled values the label |il| must be above
the current label; otherwise |il| cannot be said to protect the value.
%
(Importantly, we assumes that the |Lb| constructor cannot be accessed
directly to construct or destruct such values without label checks.)
%
