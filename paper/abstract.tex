\begin{abstract}
    ...
    mash-up security~\tocite{}, could be solved with a implementation
    of information flow control.  However, designing an IFC system which
    can be efficiently and non-intrusively implemented is quite a challenge.  In this paper,
    ...
    with.  The result is a \emph{general} method for adding IFC to existing
    languages which is \emph{indifferent} to the choice of language.
