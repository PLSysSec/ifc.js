...
secure multi-execution (SME)~\cite{Devriese:2010}. SME runs
...
SME in the context of a single, specific programming
...
IFC~\cite{Hedin:2012,ConDOM,JSFlow}. While fine-grained IFC can result
...
scenario and tend to have simpler implications~\cite{Yip:2009:PBS,DeGroef:2012,conf/esorics/AkhaweLHSS13}.
...
Erlang~\cite{Armstrong03makingreliable}.  There is a close
...
system on top of Erlang which shares some similarities to ours.
