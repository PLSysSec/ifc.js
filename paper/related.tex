...
to perform fine-grained information flow control of
JavaScript~\cite{Hedin:2012,ConDOM,JSFlow}. While fine-grained information flow
control can result in fewer false alarms and target legacy code, it comes at the
...
inter-thread communication, are reminiscent of distributed systems
