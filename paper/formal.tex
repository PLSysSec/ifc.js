...
our embedding.
%
Concretely, we show that an IFC langauge, |specLang alpha targetLang)|, satisfies non-interference~\tocite{}, without making any reference to properties of |targetLang|.
%
...
may diverge based on secret data; with the concurrent schedule,
we can show a stronger result, \emph{termination-sensitive non-interference},
