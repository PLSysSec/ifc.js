...
\begin{definition}[Information flow control language]
    ...
    \Red{It is a bit odd to extend a tuple ``sometimes'' and a |V| appears like from
      nowhere. What about saying: Sometimes, we refer as |V| to set of 
     ...
     where you said |V = ...| must be removed.}
\end{definition}
