...
.-.>
iS', sched step (iniTE (lconf id il' tS (iniE ie')))
|}

\and
\inferrule[I-evalCtx2]
{|
iS ,(iniTE (lconf id il tS ie))
.-.>
iS', (iniTE' (lconf id il' tS ie'))
|}
{|
...
.-.>
iS, sched step (iniTE (lconf id il tS' (IT te')))
|}
...
.-.>
iS', sched fork (iniTE' (lconf id' il tS' (TI ie)))
|}
%{|fresh (id')|}
...
\begin{code}
  sched step                       = Id
  sched noStep (it1, it2, ...)     = Id
  sched fork (it1, it2, ... it1n)  = itn, t1, t2, ...
\end{code}
