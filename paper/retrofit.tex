...
\begin{code}
  sched step (it1, it2, ldots)  = it2, ldots, it1
  sched D (it1, it2, ldots)     = it2, ldots
  sched N (it1, it2, ldots)     = it2, ldots
  sched F (it1, it2, ldots)     = it2, ldots, it1
\end{code}
  Sequential:
\begin{code}
  sched step (it1, it2, ldots)     = it1, it2, ldots
  sched N (it1, it2, ldots)        = it1, it2, ldots
  sched D (it)                     = it
  sched D (it1, it2, ldots)        = it2, ldots
  sched F (it1, it2, ldots, itn)   = itn, it1, it2, ldots
\end{code}
