...
%{
%format .->  = "\overset{\alpha}{\hookrightarrow}"
Using this definition, we can no expand the definition for the
...
Here we abuse notation by using metavariables to describe types that
we previously, e.g., |it| for the type of task.
}
%}
