...
%{
%format .->  = "\overset{\alpha}{\hookrightarrow}"
Using this definition, our specification language |specLang alpha
(targetLang nop) = ((iS,its), .->, erasef il)|, where |its| is a task
list containing terms from the embeddeding.
%}
...
For any target language |targetLang nop|,
|specLang roundrobinf (targetLang nop)| satisfies TSNI.
\end{theorem}
