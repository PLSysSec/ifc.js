...
\inferrule[I-evalCtx]
{|
iconf iS (lconf id il tS ie, ldots)
.->
iconf iS' (lconf id il' tS' ie', ldots)
|}
{|
...
|}
{|
iconf iS (lconf id il tS (IT te), ldots)
.->
iconf iS (lconf id il tS' (IT te'), ldots)
|}
...
{ }
{|
iconf iS (inTE id il getLabel)
.->
iconf iS (inTE id il il)
|}
...
{ |il canFlowTo il'| }
{|
iconf iS (inTE id il (setLabel il'))
.->
iconf iS (inTE id il' unit)
|}
...
{|
iconf iS  (inTE id il (send id' il' ie))
.->
iconf iS' (inTE id il unit)
|}
...
{|
iconf iS  (inTE id il (ix1, ix2 <= recv. ie1 ie2))
.->
iconf iS' (inTE id il ({ie'/ix1,id'/ix2} ie1))
|}
...
iconf iS  (inTE id il (ix1, ix2 <= recv. ie1 ie2))
.->
iconf iS' (inTE id il ie2)
|}

\inferrule[I-labelOp]
{ |denot (il1 lop il2) = iv|}
{ |iconf iS (inTE id il (il1 lop il2)) .-> iconf iS (inTE id il iv)| }

\and
\inferrule[I-border]
{ }
{|
iconf iS (inTE id il (IT (TI (ie))))
.->
iconf iS (inTE id il ie)
|}
