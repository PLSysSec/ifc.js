...
\inferrule[T-ref]
{ | ap fresh ta | }
{| conf tS (ref tv) -> conf (tS [ mapsto ta tv ]) ta |}
...
\inferrule[T-ass]
{ }
{| conf tS (ta := tv) -> conf (tS [ mapsto ta tv ]) tv |}
