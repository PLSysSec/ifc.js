...
of a language can in general break non-interference.
Second, even though the underlying
...
message, and then \textbf{send}s the task a mutable reference to |(ref
...
(we answer this question positively in Section~\ref{sec:single-heap})?
Furthermore, the na\"ive
semantics violates expectations about how inter-task communication
...
between tasks, rather than general object structures).
