...
iTE  ::=  iTE, lconf id il tS ie, ldots
...
|}
{|
iconf iS (iniTE (lconf id il tS (iniE ie)))
.->
iconf iS' (iniTE (lconf id il' tS (iniE ie')))
|}
...
|}
{|
iconf iS (iniTE (lconf id il tS (IT te)))
.->
iconf iS (iniTE (lconf id il tS' (IT te')))
|}
...
{|
iconf iS (lconf id il tS (fork ie), ldots)
.->
iconf iS' (lconf id il tS id', ldots, lconf id' il tS' (TI ie))
|}
%{|fresh (id')|}
