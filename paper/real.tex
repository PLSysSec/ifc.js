...
label which is, in turn, used by functions such as |getLabel| to
define the IFC core.
%
...
monadic subset of Haskell in the \verb|LIO| monad is the IFC language.

Indeed, by rephrasing LIO in terms of our framework, we simplified
LIO's treatment of exceptions, which have since been integrated in the
code-base.
%
we addressed a limitation in LIO.
