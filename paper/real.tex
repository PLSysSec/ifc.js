\section{Retrofitting ECMAScript with IFC}
\label{sec:real}
\Red{ALE: Here, Deian needs to fit the core part of COWL, i.e., with no external
  effects. It will be nice to have the COWL API and map it to IFC-Inside}
